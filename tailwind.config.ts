  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "analysis-signal-position": {
          "0%": { transform: "translateX(0%)" },
          "42%": { transform: "translateX(50%)" },
          "76%, 100%": { transform: "translateX(100%)" },
        },
        "analysis-signal-dot": {
          "0%": { color: "var(--motion-analysis)", transform: "scale(1)" },
          "21%": { color: "var(--motion-analysis)", transform: "scale(1.3333)" },
          "42%": { color: "var(--motion-signal)", transform: "scale(1)" },
          "59%": { color: "var(--motion-signal)", transform: "scale(1.3333)" },
          "76%": { color: "var(--motion-lens)", transform: "scale(1)" },
          "88%": { color: "var(--motion-lens)", transform: "scale(1.3333)" },
          "100%": { color: "var(--motion-lens)", transform: "scale(1)" },
        },
        "return-reveal": {
          from: { opacity: "0" },
          to: { opacity: "1" },
      ...
      animation: {
        ...
        "analysis-signal-position": "analysis-signal-position 3.6s ease-in-out infinite alternate",
        "analysis-signal-dot": "analysis-signal-dot 3.6s ease-in-out infinite alternate",
