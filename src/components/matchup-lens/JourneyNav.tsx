...
/** Focused lens switcher. Overview navigation lives in the sticky context bar. */
export function JourneyLensNav({ value, options, onChange, onPrev, onNext }: JourneyNavProps) {
  return (
