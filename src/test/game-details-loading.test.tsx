...
describe("Game Details Matchup Briefing", () => {
  it("shows recognized navigation identity and truthful static scope", () => {
    ...
    expect(loading.querySelectorAll(".animate-analysis-signal-position")).toHaveLength(1);
    expect(loading.querySelectorAll(".animate-analysis-signal-dot")).toHaveLength(1);
  ...
  it("contains no premature scores, evidence, conclusions, or animated placeholders", () => {
    ...
    expect(container.querySelectorAll(".animate-analysis-signal-position")).toHaveLength(1);
    expect(container.querySelectorAll(".animate-analysis-signal-dot")).toHaveLength(1);
    expect(screen.getByTestId("analysis-progress-rail").querySelectorAll("[class*='border-motion-']")).toHaveLength(0);
